...
distributionPlot(dat(:, 1), 'histOri', 'left', 'widthDiv', [2 1], 'showMM', 0, ...
    'color',  mat2cell(colors(1, :), 1));
%subplot(4,7,7); hold on;
distributionPlot(dat(:, 2), 'histOri', 'right', 'widthDiv', [2 2], 'showMM', 0, ...
...
print(gcf, '-dpdf', 'BeautifulPlotsNEM.pdf');

function [efs,F,cdfs,p,eps,dfs,b,y2,sig,mses,msss,partial_eta_squared,effectname]=repanova(d,D,fn,gg,alpha,display_results)	
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% [efs,F,cdfs,p,eps,dfs,b,y2,sig,mses,msss,partial_eta_squared,effectname]=repanova(d,D,fn,gg,alpha);	
...
% mses  = cell array of mean squared errors for each effect
% msss  = cell array of mean sum of squares for each effect
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    partial_eta_squared(e) = F(e)*1./(F(e)*1+cdfs(e,2));
    ...
    if display_results
        disp(sprintf('Effect %02d: %-18s F(%3.2f,%3.2f)=%4.3f,\tp=%g,\tpartial_eta_squ=%g',...
            e,en,cdfs(e,1),cdfs(e,2),F(e),p(e),partial_eta_squared(e)))
    end
    effectname{e} = en;
    mses{e} = mse;
    msss{e} = mss;
